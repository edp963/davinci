...
public class ViewSqlProvider {
    ...
    public String insertSelective(View record) {
        ...
        if (record.getSql() != null) {
            sql.VALUES("`sql`", "#{sql,jdbcType=LONGVARCHAR}");
        }
        
        if (record.getModel() != null) {
            sql.VALUES("model", "#{model,jdbcType=LONGVARCHAR}");
        }
        
        if (record.getVariable() != null) {
            sql.VALUES("`variable`", "#{variable,jdbcType=LONGVARCHAR}");
        }
    ...
    public String selectByExampleWithBLOBs(ViewExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getSql() != null) {
            sql.SET("`sql` = #{record.sql,jdbcType=LONGVARCHAR}");
        }
        
        if (record.getModel() != null) {
            sql.SET("model = #{record.model,jdbcType=LONGVARCHAR}");
        }
        
        if (record.getVariable() != null) {
            sql.SET("`variable` = #{record.variable,jdbcType=LONGVARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(View record) {
        ...
        if (record.getSql() != null) {
            sql.SET("`sql` = #{sql,jdbcType=LONGVARCHAR}");
        }
        
        if (record.getModel() != null) {
            sql.SET("model = #{model,jdbcType=LONGVARCHAR}");
        }
        
        if (record.getVariable() != null) {
            sql.SET("`variable` = #{variable,jdbcType=LONGVARCHAR}");
        }
