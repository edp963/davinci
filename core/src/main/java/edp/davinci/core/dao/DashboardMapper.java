...
public interface DashboardMapper {
    ...
    @SelectProvider(type=DashboardSqlProvider.class, method="selectByExampleWithBLOBs")
    @Results({
    ...
    @Select({
        "select",
        "id, `name`, dashboard_portal_id, `type`, `index`, parent_id, full_parent_Id, ",
        "create_by, create_time, update_by, update_time, config",
        "from dashboard",
        "where id = #{id,jdbcType=BIGINT}"
    })
    @Results({
    ...
    @UpdateProvider(type=DashboardSqlProvider.class, method="updateByExampleWithBLOBs")
