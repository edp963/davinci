...
public interface MemDashboardWidgetMapper {
    ...
    @Insert({
        ...
        "#{frequency,jdbcType=INTEGER}, #{createBy,jdbcType=BIGINT}, ",
    ...
    @SelectProvider(type=MemDashboardWidgetSqlProvider.class, method="selectByExampleWithBLOBs")
    @Results({
    ...
    List<MemDashboardWidget> selectByExampleWithBLOBs(MemDashboardWidgetExample example);
    ...
    @Select({
        "select",
        "id, dashboard_id, widget_Id, x, y, width, height, polling, frequency, create_by, ",
        "create_time, update_by, update_time, config",
    ...
    @UpdateProvider(type=MemDashboardWidgetSqlProvider.class, method="updateByExampleWithBLOBs")
    int updateByExampleWithBLOBs(@Param("record") MemDashboardWidget record, @Param("example") MemDashboardWidgetExample example);
    ...
    int updateByPrimaryKeyWithBLOBs(MemDashboardWidget record);
