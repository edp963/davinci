...
import edp.davinci.core.dao.entity.SourceExample.Criteria;
import edp.davinci.core.dao.entity.SourceExample.Criterion;
...
public class SourceSqlProvider {
    ...
    public String selectByExampleWithBLOBs(SourceExample example) {
        SQL sql = new SQL();
