...
public interface DisplayMapper {
    ...
    @SelectProvider(type=DisplaySqlProvider.class, method="selectByExampleWithBLOBs")
    @Results({
    ...
    List<Display> selectByExampleWithBLOBs(DisplayExample example);
    ...
    @UpdateProvider(type=DisplaySqlProvider.class, method="updateByExampleWithBLOBs")
    int updateByExampleWithBLOBs(@Param("record") Display record, @Param("example") DisplayExample example);
