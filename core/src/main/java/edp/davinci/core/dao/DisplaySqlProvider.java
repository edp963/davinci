...
import edp.davinci.core.dao.entity.DisplayExample.Criteria;
import edp.davinci.core.dao.entity.DisplayExample.Criterion;
import edp.davinci.core.dao.entity.DisplayExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class DisplaySqlProvider {

    public String countByExample(DisplayExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("display");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(DisplayExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("display");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(Display record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("display");
    ...
    public String selectByExampleWithBLOBs(DisplayExample example) {
        SQL sql = new SQL();
    ...
    public String selectByExample(DisplayExample example) {
        SQL sql = new SQL();
        if (example != null && example.isDistinct()) {
            sql.SELECT_DISTINCT("id");
        } else {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        Display record = (Display) parameter.get("record");
        DisplayExample example = (DisplayExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(Display record) {
        SQL sql = new SQL();
        sql.UPDATE("display");
    ...
    protected void applyWhere(SQL sql, DisplayExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
