...
public interface SourceMapper {
    ...
    @Insert({
        ...
        "#{projectId,jdbcType=BIGINT}, #{createBy,jdbcType=BIGINT}, ",
    ...
    @SelectProvider(type=SourceSqlProvider.class, method="selectByExampleWithBLOBs")
    @Results({
    ...
    @Select({
        "select",
        "id, `name`, description, `type`, project_id, create_by, create_time, update_by, ",
        "update_time, parent_id, full_parent_id, is_folder, `index`, config",
        "from source",
        "where id = #{id,jdbcType=BIGINT}"
    })
    @Results({
    ...
    @UpdateProvider(type=SourceSqlProvider.class, method="updateByExampleWithBLOBs")
