...
public interface MemDisplaySlideWidgetMapper {
    ...
    @Insert({
        ...
        "widget_id, `name`, params, ",
        "`type`, sub_type, ",
        "`index`, create_by, ",
        "create_time, update_by, ",
        "update_time)",
        "values (#{id,jdbcType=BIGINT}, #{displaySlideId,jdbcType=BIGINT}, ",
        "#{widgetId,jdbcType=BIGINT}, #{name,jdbcType=VARCHAR}, #{params,jdbcType=VARCHAR}, ",
        "#{type,jdbcType=SMALLINT}, #{subType,jdbcType=SMALLINT}, ",
    ...
    @Select({
        "select",
        "id, display_slide_id, widget_id, `name`, params, `type`, sub_type, `index`, ",
