...
public interface RelUserOrganizationMapper {
    ...
    @Insert({
        ...
        "user_id, `role`, create_by, ",
        "create_time, update_by, ",
        "update_time)",
        "values (#{id,jdbcType=BIGINT}, #{orgId,jdbcType=BIGINT}, ",
        "#{userId,jdbcType=BIGINT}, #{role,jdbcType=SMALLINT}, #{createBy,jdbcType=BIGINT}, ",
    ...
    @Select({
        "select",
        "id, org_id, user_id, `role`, create_by, create_time, update_by, update_time",
