...
public interface ViewMapper {
    ...
    @Insert({
        ...
        "#{sourceId,jdbcType=BIGINT}, #{sql,jdbcType=VARCHAR}, #{model,jdbcType=VARCHAR}, ",
        "#{variable,jdbcType=VARCHAR}, #{config,jdbcType=VARCHAR}, ",
    ...
    @Select({
        "select",
        "id, `name`, description, project_id, source_id, `sql`, model, `variable`, config, ",
        "create_by, create_time, update_by, update_time, parent_id, full_parent_id, is_folder, ",
        "`index`",
        "from view",
        "where id = #{id,jdbcType=BIGINT}"
    })
