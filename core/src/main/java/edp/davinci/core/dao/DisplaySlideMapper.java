...
public interface DisplaySlideMapper {
    ...
    @Insert({
        ...
        "#{index,jdbcType=INTEGER}, #{createBy,jdbcType=BIGINT}, ",
    ...
    @SelectProvider(type=DisplaySlideSqlProvider.class, method="selectByExampleWithBLOBs")
    @Results({
    ...
    List<DisplaySlide> selectByExampleWithBLOBs(DisplaySlideExample example);
    ...
    @Select({
        "select",
        "id, display_id, `index`, create_by, create_time, update_by, update_time, config",
        "from display_slide",
        "where id = #{id,jdbcType=BIGINT}"
    })
    @Results({
    ...
    @UpdateProvider(type=DisplaySlideSqlProvider.class, method="updateByExampleWithBLOBs")
    int updateByExampleWithBLOBs(@Param("record") DisplaySlide record, @Param("example") DisplaySlideExample example);
    ...
    int updateByPrimaryKeyWithBLOBs(DisplaySlide record);
