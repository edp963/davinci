...
case class Config4QuerySql(name:String,sql_tmpl:String,result_table:String,url:String,sql_param:Option[Option[String]])

case class Config4UpdateSql(name:String,updateSql:Option[String], result_table:String, url:String, sql_param:Option[Option[String]])
