...
export type Diff<T extends object, U extends object> = Omit<T, Extract<keyof T, keyof U>>

export type Compute<T extends any> = T extends () => void ? T : {[U in keyof T]: T[U]}

export type Merge<T extends object, U extends object> = Compute<T & Omit<U, keyof T>>

export type DeepPartial<T> = {[U in keyof T] ?: T[U] extends object ? DeepPartial<T[U]> : T[U]}
