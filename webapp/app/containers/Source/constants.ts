...
enum Types {
  ...
  LOAD_SOURCE_DETAIL_FAILURE = 'davinci/Source/LOAD_SOURCE_DETAIL_FAILURE',
  ...
  SET_SOURCE_FORM_VALUE = 'davinci/Source/SET_SOURCE_FORM_VALUE',
  SET_UPLOAD_FORM_VALUE = 'davinci/Source/SET_UPLOAD_FORM_VALUE',
